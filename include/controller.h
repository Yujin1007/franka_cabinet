...
private:
    ...
    Matrix3d rotation_calc(double pi, double psi, Matrix3d R_hand);
    Vector3d rotationdot_circular(Matrix3d r1, Matrix3d r0);
    struct Robot{
		int id;
		Vector3d pos;
    ...
    Matrix3d _R_des_hand, _R_hand, _R_hand_ref;
