...
def main(PATH, TRAIN, RENDERING):
    ...
    if TRAIN:
        ...
        # trainer1.load(pretrained_model_dir)

        actor1.train()
        # actor2.train()
        return_rotation_max = -np.inf
        return_force_max = -np.inf
        for t in range(int(max_timesteps)):
            ...
            if save_flag:
                path1 = models_dir + str((episode_num + 1) // save_freq) + "/"
        ...
        pretrained_model_dir1 = pretrained_model_dir
