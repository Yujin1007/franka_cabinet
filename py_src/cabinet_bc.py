    ...
    if TRAIN:
        if Collect_Data:
            ...
            for epoch in range(num_epochs):
                ...
                action_force = env.controller.get_force_gain()
            ...
            save_replay_buffer(replay_buffer1, expert_path + 'replay_buffer_rotation1.pkl')
            save_replay_buffer(replay_buffer2, expert_path + 'replay_buffer_force1.pkl')


        expert1_path = './log/expert/replay_buffer_rotation1.pkl'
        expert2_path = './log/expert/replay_buffer_force1.pkl'
        ...
        state_dict=torch.load(PATH + "model1.pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", help="data load path", default=" ./log/bc/0709_1/")
